...
export class ObjectControllerService {
     ...
     */
    public createObject(newObject: NewObject, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ObjectInstance>;
    public createObject(newObject: NewObject, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ObjectInstance>>;
    public createObject(newObject: NewObject, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ObjectInstance>>;
    public createObject(newObject: NewObject, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (newObject === null || newObject === undefined) {
            throw new Error('Required parameter newObject was null or undefined when calling createObject.');
        }
        ...
        return this.httpClient.post<ObjectInstance>(`${this.configuration.basePath}/objects`,
            newObject,
            {
