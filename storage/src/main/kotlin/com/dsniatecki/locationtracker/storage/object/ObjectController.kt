...
class ObjectController(
    ...
    fun getObjects(@RequestParam(name = "ids", required = false) ids: Set<String>?): Publisher<ObjectInstance> =
        if (ids.isNullOrEmpty()) objectService.getAll() else objectService.getMultiple(ids)
